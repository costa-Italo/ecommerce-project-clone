const NewsletterForm = () => {
  return (
    <div className="flex justify-between gap-10 items-center">
      ...
      <button className="px-7 py-5 text-white bg-gray-950 max-md:px-5 transition-transform transform hover:scale-105 w-44 h-14 flex items-center justify-center rounded-lg">
